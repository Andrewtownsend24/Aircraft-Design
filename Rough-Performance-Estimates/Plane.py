...
class Plane(object):
    ...
    def __init__(self, filename, plane_airfoil_str, wing_span, chord, swept_angle, air_density_at_cruise,
        ...
        self._cL_slope = (self._cL[len(self._cL) - 1] - self._cL[0]) / (end_angle - start_angle)

        self._cd0 = self._cdx[start_index]
        for i in range(start_index, end_index + 1):
...
class PlaneList:
    ...
    def write_csv(self):
        ...
        # name of csv file  
        filename = "Rough-Performance-Estimates/Designs/university_records.csv"

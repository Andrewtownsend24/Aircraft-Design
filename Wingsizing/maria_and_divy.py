...
for i in range(0,58):
    x.append(i)
    x0.append(0)
print("The w_s_stall is ", w_s_stall)
plt.fill_between(x, w_s_stall , x0, color='b', alpha=0.2, hatch='/')
plt.fill_between(w_s, w_p_ROC, 0, color='r', alpha=0.2, hatch='/')
plt.fill_between(w_s, w_p_sTO, 0, color='y', alpha=0.2, hatch='/')
plt.fill_between(w_s, w_p_cruise, 0, color='g', alpha=0.2, hatch='/')
plt.fill_between(w_s, w_p_vmax, 0, color='k', alpha=0.2, hatch='/')
